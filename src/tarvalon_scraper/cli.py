...
def print_header():
    ...
    badges = Text.from_markup("[bold black on bright_cyan] VERSION 0.2.0 [/bold black on bright_cyan]  [bold white on magenta] LIBRARY SCRAPER [/bold white on magenta]  [bold black on bright_green] ONLINE [/bold black on bright_green]")
